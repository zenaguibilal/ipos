...
تحويل كافة المستودعات لتكون المصدر الوحيد والحتمي للحقيقة من جهة الخادم. كافة الحسابات المالية والمنطقية (الديون، المخزون، الفواتير) تتم في طبقة المستودعات.

### PHASE 3: API WALL (100/100 COMPLETED)
بناء جدار حماية صلب. تم عزل واجهة المستخدم تماماً عن قاعدة البيانات والمستودعات عبر نهايات طرفية محصنة (/api). تم حذف كافة المستودعات من جهة العميل وتجريم استخدامها خارج الخادم.
...
---
**تحذير معمارية:** أي محاولة لاستيراد ملف من `@/repositories` داخل مكون عميل ستعتبر خرقاً أمنياً وسيتم إبادتها فوراً.
