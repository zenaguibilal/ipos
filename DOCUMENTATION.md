...
تم إبادة طبقة "الخدمات" (Services) من جهة العميل تماماً. المكونات والـ Store يتصلون الآن مباشرة بـ API Wall. تم توحيد مسار البيانات (Component -> API -> Repository). تم ترحيل منطق الـ CSV إلى مكتبة أدوات موحدة.
...
---
**تحذير معمارية:** أي محاولة لاستخدام Supabase client أو استيراد مستودع داخل مكون عميل ستعتبر خرقاً أمنياً وسيتم إبادتها فوراً. الطبقة الوحيدة المسموح بالتعامل معها هي `/api`.
