...
export const StockIntakeCard = React.memo<StockIntakeCardProps>(({ intake, supplierName, onViewDetails, onCancelIntake }) => {
    ...
    return (
        <Card className="luxury-glass border-white/5 bg-muted/10 transition-all duration-500 hover:shadow-2xl hover:border-primary/20 group relative overflow-hidden">
            ...
            <CardFooter className="bg-primary/5 p-4 border-t border-white/5 mt-auto relative z-10">
