    ...
    <Card className={cn(
        ...
        <CardContent className="p-4 pt-0 flex-grow space-y-4">
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    <Label htmlFor={`paid-${order.id}`} className="text-base">Payé</Label>
                    <Switch
                        id={`paid-${order.id}`}
                        checked={isPaid}
                        onCheckedChange={(value) => onUpdateStatus('isPaid', value)}
                        disabled={isUpdating}
                    />
                </div>
                 <div className="flex items-center justify-between">
                    ...
                    <Switch
                        ...
                        checked={isDelivered}
                        onCheckedChange={(value) => onUpdateStatus('isDelivered', value)}
                        disabled={isUpdating}
                    />
                </div>
            </div>
