                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="py-4">
                        ...
                        <div className="mt-4 flex justify-around">
                            <Button type="button" variant="outline" onClick={() => setQuantity(String(order.defaultOrderQuantity))}>Par défaut ({order.defaultOrderQuantity})</Button>
                            <Button type="button" variant="outline" onClick={() => setQuantity('0')}>Zéro</Button>
                        </div>
                    </div>
                    <DialogFooter>
