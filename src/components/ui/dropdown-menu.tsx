...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-primary/10 bg-popover/70 p-1 text-popover-foreground shadow-lg backdrop-blur-xl",
