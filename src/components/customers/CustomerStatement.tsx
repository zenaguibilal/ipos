        ...
        <div ref={ref} className="p-4 bg-white text-black font-sans">
            ...
            <section className="my-6">
                ...
                {unpaidSales.length > 0 ? (
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b">
                                ...
                                <th className="text-right p-2 font-bold">Reste</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <p className="text-gray-600 p-4 bg-gray-100 rounded text-center">Aucune facture impayée.</p>
                )}
            </section>

            <footer className="mt-8 pt-4 border-t text-center text-xs text-gray-500">
                <p>iPOS - Document Professionnel</p>
            </footer>
        </div>
    );
});
