        ...
        <div className="p-4 sm:p-6 space-y-6">
            <header className="flex flex-col sm:flex-row gap-4 justify-between items-start">
                <div className="flex items-center gap-4">
                     ...
                     <div>
                        <h1 className="text-2xl font-bold">Nouveau Retour de Produit</h1>
                        <p className="text-muted-foreground">Enregistrez un retour sur la base d'une vente existante.</p>
                     </div>
                </div>
                {foundSale && (
